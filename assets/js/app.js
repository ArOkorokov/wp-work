(() => {
    ...
    function initSliders() {
        if (document.querySelector(".bakery-slider-slid__slider")) new core(".bakery-slider-slid__slider", {
            ...
            autoplay: true,
            navigation: {
                prevEl: ".slider-bakery-arrows-left",
                nextEl: ".slider-bakery-arrows-right"
            },
            on: {}
        });
...
***************************************************************************** */
    ...
    function menu() {
        const bt = document.querySelector(".icon-menu");
        const mu = document.querySelector(".menu__list");
        bt.addEventListener("click", (function(e) {
            mu.classList.toggle("menu-active");
        }));
    }
    menu();
    function gall() {
        const gl = document.querySelector(".bakery-gallery");
        lightgallery_es5(gl);
    }
    gall();
    function sm() {
        const showMore = document.querySelector(".show-more");
        const productsLength = document.querySelectorAll(".dessert-show_item").length;
        let items = 8;
        showMore.addEventListener("click", (() => {
            items += 4;
            const array = Array.from(document.querySelector(".dessert-show__content").children);
            const visItems = array.slice(0, items);
            visItems.forEach((el => el.classList.add("is-visible")));
            if (visItems.length === productsLength) showMore.style.display = "none";
        }));
    }
    sm();
    function initMap() {
        ...
        const map = new google.maps.Map(document.querySelector(".footer-map-wrapper"), {
            zoom: 4,
            center: uluru
        });
